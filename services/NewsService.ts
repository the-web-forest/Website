...
export default class NewsService {
    ...
    getAllNews(): News[] {
        return [
            new News({
                title: 'Amazônia pode ter 15 mil km² de área desmatada até julho, aponta plataforma',
            ...
            new News({
                title: 'Plantar árvores já é insuficiente para sanar gás carbônico da atmosfera',
                photoUrl: 'https://www.cnnbrasil.com.br/wp-content/uploads/sites/12/2021/06/21204_DBDEF0EC8D945527.jpg?w=876&h=484&crop=1',
                date: '16/12/2020',
            ...
            new News({
                title: 'Mundo precisa de 1,2 trilhão de novas árvores para conter o aquecimento global, diz estudo',
                photoUrl: 'https://veja.abril.com.br/wp-content/uploads/2021/06/AAA7711.JPG.jpg',
                date: '04/07/2019',
            ...
            new News({
                ...
                photoUrl: 'https://images.unric.org/pt/wp-content/uploads/sites/9/2021/10/IV4fRr3Q_400x400.jpg.webp',
                date: '09/10/2021',
            ...
            new News({
                ...
                photoUrl: 'https://wwfbr.awsassets.panda.org/img/wwf_canon___mark_edwards___acre_108941.jpg',
                date: '01/08/2020',
