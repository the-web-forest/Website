...
const ContactSection = () => {
	const [formData, setFormData] = useState<ContactDataDTO>(
		ContactDataDTO.getInstance()
	);
	...
	const changeForm = (value: string, field: EFields) => {
		return setFormData({
			...formData,
			[field]: value
		});
	...
	const isFormValid = (): boolean => {
		...
		const allFields = [nameFieldIsValid, emailFieldIsValid, messageFieldIsValid];
				...
				{!messageSent && (
					<div id={styles.form}>
						<Input
							...
							value={formData.name}
							onChangeFunction={(value) => changeForm(value, EFields.NAME)}
							maxLength={50}
						...
						<Input
							...
							onChangeFunction={(value) => changeForm(value, EFields.EMAIL)}
							maxLength={50}
						...
						<TextArea
							...
							onChangeFunction={(value) => changeForm(value, EFields.MESSAGE)}
