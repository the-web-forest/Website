import MonthHelper from 'api/helpers/monthHelper';
import MonthDto from 'api/services/transparency/dtos/month.dto';
import MonthSheetDto from 'api/services/transparency/dtos/monthSheet.dto';
...
export default class ListMonthsUseCase {
	...
	private populateYears(dataList: MonthSheetDto[], years: YearDto[]): YearDto[] {
