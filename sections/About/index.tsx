...
const AboutSection = () => {
  ...
  const TEXT = {
    ONE: `Fazemos do nosso trabalho uma voz para o meio ambiente, o mundo no qual vivemos. Proteger a fauna, financiar pesquisas ambientais, reflorestar campos e incentivar comunidades indígenas são pautas de interesse da Web Forest.`,
    TWO: `A Web Forest se concentra hoje em criar tecnologias e conectar pessoas e instituições parceiras para realizar serviços ambientais. Nossa missão não é “por a mão na terra” em si, mas ajudar as pessoas que estão dispostas a isso. `,
